...
//include_once(__DIR__.'/../class/confirm_regist_data_output.php');
...
// instance_method
/*
$confirmRegistDataOutput = new confirm_regist_data_output();
$genders = $confirmRegistDataOutput->genders_data_confirm_regist();
$ages = $confirmRegistDataOutput->ages_data_confirm_regist();
$prefectures = $confirmRegistDataOutput->prefectures_data_confirm_regist();
*/
...
if(isset($_POST['check'])){
  ...
  $complete = $memberAuthProcess->member_regist($_SESSION,$genders,$ages,$prefectures,$complete);
  if(empty($complete)){
    $errorMessage['failed_member_regist'] = '新規登録に失敗しました';
  }
 ...
 * form,post(complete_regist.php)
 * link(regist_form.php)
-->
<!DOCTYPE html>
<html lang="ja">
<head>
...
<body>
  <div class="container">
    <?php if(isset($errorMessage['failed_member_regist'])):?>
      <div class="error-message"><?php echo hsc($errorMessage['failed_member_regist']);?></div>
    <?php endif;?>
    <form name="confirm-regist-form" method="POST">
    ...
    <div class="section-frame">
      ...
      <a href="../public/regist_form.php" class="back-btn">変更</a>
    </div>
    </form>
  </div>
